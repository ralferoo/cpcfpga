...
;	call dumpcontents
	...
	ld de,#10
	ld hl, file_header_image_start
	ld ix, file_header_image_length 
	call writebytes

	ld de,#11
	ld hl, file_image_start
	ld ix, file_image_length 
	call writebytes
...
file_header_image_start:
; block header
        defb 1                  ; AMSDOS file
        defw #83+2+#10          ; next free page
; AMSDOS header
        defb "BB4CPC"
        defs 10                 ; 16 chars name

        defb 0,0                ; blocks not used
        defb 0                  ; BASIC
        defw 0                  ; bytes per record
        defw #170               ; starting address
        defb 0                  ; first block
        defw #82f4              ; length
        defw 0                  ; execution address
file_header_image_length equ ($-file_header_image_start)
